...
public class ExtractResultItem implements org.apache.thrift.TBase<ExtractResultItem, ExtractResultItem._Fields>, java.io.Serializable, Cloneable, Comparable<ExtractResultItem> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ExtractResultItem");
  ...
  static {
    schemes.put(StandardScheme.class, new ExtractResultItemStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ExtractResultItemTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ExtractResultItem.class, metaDataMap);
  }
   ...
   */
  public ExtractResultItem(ExtractResultItem other) {
  ...
  public ExtractResultItem deepCopy() {
    return new ExtractResultItem(this);
  }
  ...
  public ExtractResultItem setFileName(String fileName) {
    this.fileName = fileName;
    return this;
  }
  ...
  public ExtractResultItem setStream(byte[] stream) {
    this.stream = stream == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(stream, stream.length));
    return this;
  }

  public ExtractResultItem setStream(ByteBuffer stream) {
    this.stream = org.apache.thrift.TBaseHelper.copyBinary(stream);
    return this;
  }
  ...
  public ExtractResultItem setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public ExtractResultItem setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ExtractResultItem)
      return this.equals((ExtractResultItem)that);
    return false;
  }

  public boolean equals(ExtractResultItem that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ExtractResultItem other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ExtractResultItem(");
    boolean first = true;
  ...
  private static class ExtractResultItemStandardSchemeFactory implements SchemeFactory {
    public ExtractResultItemStandardScheme getScheme() {
      return new ExtractResultItemStandardScheme();
    }
  }

  private static class ExtractResultItemStandardScheme extends StandardScheme<ExtractResultItem> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ExtractResultItem struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExtractResultItem struct) throws TException {
      struct.validate();
  ...
  private static class ExtractResultItemTupleSchemeFactory implements SchemeFactory {
    public ExtractResultItemTupleScheme getScheme() {
      return new ExtractResultItemTupleScheme();
    }
  }

  private static class ExtractResultItemTupleScheme extends TupleScheme<ExtractResultItem> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ExtractResultItem struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ExtractResultItem struct) throws TException {
