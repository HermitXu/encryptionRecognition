...
public class ExtractParams implements org.apache.thrift.TBase<ExtractParams, ExtractParams._Fields>, java.io.Serializable, Cloneable, Comparable<ExtractParams> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ExtractParams");
  ...
  static {
    schemes.put(StandardScheme.class, new ExtractParamsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ExtractParamsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ExtractParams.class, metaDataMap);
  }
   ...
   */
  public ExtractParams(ExtractParams other) {
  ...
  public ExtractParams deepCopy() {
    return new ExtractParams(this);
  }
  ...
  public ExtractParams setStream(byte[] stream) {
    this.stream = stream == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(stream, stream.length));
    return this;
  }

  public ExtractParams setStream(ByteBuffer stream) {
    this.stream = org.apache.thrift.TBaseHelper.copyBinary(stream);
    return this;
  }
  ...
  public ExtractParams setFileName(String fileName) {
    this.fileName = fileName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ExtractParams)
      return this.equals((ExtractParams)that);
    return false;
  }

  public boolean equals(ExtractParams that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ExtractParams other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ExtractParams(");
    boolean first = true;
  ...
  private static class ExtractParamsStandardSchemeFactory implements SchemeFactory {
    public ExtractParamsStandardScheme getScheme() {
      return new ExtractParamsStandardScheme();
    }
  }

  private static class ExtractParamsStandardScheme extends StandardScheme<ExtractParams> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ExtractParams struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ExtractParams struct) throws TException {
      struct.validate();
  ...
  private static class ExtractParamsTupleSchemeFactory implements SchemeFactory {
    public ExtractParamsTupleScheme getScheme() {
      return new ExtractParamsTupleScheme();
    }
  }

  private static class ExtractParamsTupleScheme extends TupleScheme<ExtractParams> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ExtractParams struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ExtractParams struct) throws TException {
